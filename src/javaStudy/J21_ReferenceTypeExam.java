package javaStudy;
/*
 * 기본형 타입을 다른 메소드의 매개변수로 전달될 때 값 그대로
 * 
 * 참조형 타입은 다른 메소드의 매개변수로 전달될 때는 주소값을 전달
 */
class J21_ReferenceTypeExam {
    public static void main(String []args) {
        J21_ReferenceTypeExam exam = new J21_ReferenceTypeExam();
        
        //기본형 변수value을 addOne에 전달합니다.
        int value = 10;
        exam.addOne(value);
